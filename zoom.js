  ...
  const grupo2 = [
    ...
    "img/foto13.jpg", "img/foto14.jpg", "img/foto15.jpg", "img/foto16.jpg"
  ];
  ...
  function mostrarGaleria() {
    ...
    document.querySelector('.texto-quienes-somos').style.display = 'none';
  ...
  function volverInicio() {
    ...
    document.querySelector('.texto-quienes-somos').style.display = 'block';
    document.querySelector('.zoom-scroll').style.display = 'block';
    document.getElementById('quienessomos').style.display = 'flex';
    document.querySelector('.servicios-container').style.display = 'grid';
    document.getElementById('contacto').style.display = 'flex';
    document.getElementById('footer1').style.display = 'flex';
